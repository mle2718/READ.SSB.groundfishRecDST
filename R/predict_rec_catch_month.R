...
x = 2
mon = 9
calibration_data_table =  readr::read_rds(file.path(paste0("C:/Users/kimberly.bastille/Desktop/codhad_data/calibration/pds_new_all_", mon, "_", x, ".rds")))
...
size_data_read = read.csv("C:/Users/kimberly.bastille/Desktop/codhad_data/projected_CaL_cod_hadd.csv")
costs_new_all =  readr::read_rds(paste0("C:/Users/kimberly.bastille/Desktop/codhad_data/calibration/cost_new_all_",mon, "_", x, ".rds"))
catch_data_all = read.csv(paste0("C:/Users/kimberly.bastille/Desktop/codhad_data/catch_draws/catch_draws", x, ".csv"))
#l_w_conversion =
n_drawz = 50
n_catch_draws = 30
eff_seed=130
...
predict_rec_catch_month <- function( x, mon,  calibration_data_table,
  ...
  cod_size_data <- size_data_read %>% dplyr::filter(species == "cod", month == mon)
  had_size_data <- size_data_read %>% dplyr::filter(species == "hadd", month == mon)
  ...
  sims <- calibration_data %>%
    ...
    tidyr::separate(period, into = c("month", "day", "mode")) %>%
