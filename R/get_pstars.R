...
# pr_8<- calculate_pstars("pr", 8, .1, .75)
...
pr_10<- calculate_pstars("pr", 10, .15, .65)
...
### pstars by yr
fh<- calculate_pstars_yr("fh", .5, .5)
write.csv(fh, file = "C:/Users/kimberly.bastille/Desktop/codhad_data/pstars/pstar_fh.csv")
pr<- calculate_pstars_yr("pr", .5, .5)
write.csv(pr, file = "C:/Users/kimberly.bastille/Desktop/codhad_data/pstars/pstar_pr.csv")
sh<- calculate_pstars_yr("sh",  .5, .5)
write.csv(sh, file = "C:/Users/kimberly.bastille/Desktop/codhad_data/pstars/pstar_sh.csv")
